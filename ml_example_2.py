...
def test_with_single_indicator_values(stock_values, rsi_thresholds, ma_thresholds, ema_thresholds):
    ...
    df['Binary_Target'] = (df['Target'] == 5).astype(int)
    ...
    'Volatility', 'percent_open', 'percent_close', 'percent_high', 'percent_low']
    ]
    y = df['Binary_Target']
   ...
   # Train the model
    ...
    threshold = 0.7  # This is an example; adjust based on your specific needs
